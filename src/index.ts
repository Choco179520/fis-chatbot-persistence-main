...
const requestLoggerMiddleware: RequestHandler = (req: Request, _res: Response, next: NextFunction) => {
...
const setCspHeader: RequestHandler = (_req: Request, res: Response, next: NextFunction) => {
...
const cacheMiddleware: RequestHandler = (req: Request, res: Response, next: NextFunction) => {
